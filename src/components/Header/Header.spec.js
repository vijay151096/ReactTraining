...
describe("Product Component Layout", () => {
  ...
  it("should display the button to go to cart page", () => {
    const mockComponent = (
        <UserContext.Provider value={{ isAuthenticated: true, login: jest.fn(), logout: jest.fn() }} >
          <BrowserRouter>
            <Header />
          </BrowserRouter>
  ...
  it("should logout when logout button is clicked", () => {
    ...
    const mockComponent = (
        <UserContext.Provider value={{ isAuthenticated: true, login: jest.fn(), logout: logoutFunction}} >
          <BrowserRouter>
            <Header />
          </BrowserRouter>
        </UserContext.Provider>
  ...
  it("should not display logout Not Authenticated", () => {
    ...
    const logoutFunction = jest.fn();
    const mockComponent = (
        <UserContext.Provider value={{ isAuthenticated: false, login: jest.fn(), logout: logoutFunction}} >
          <BrowserRouter>
            <Header />
          </BrowserRouter>
        </UserContext.Provider>
