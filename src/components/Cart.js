...
function Cart() {
    ...
    return (
      <>
        <ListItem alignItems="flex-start">
          <ListItemAvatar>
            <Avatar alt="Remy Sharp" src={cartItem.avatar} />
          </ListItemAvatar>
          <ListItemText
          ...
          />
            <Button size="small" onClick={(e) => handleClick(e, cartItem.id)}>Remove</Button>
        </ListItem>
  ...
  return (
      <List sx={{ width: "100%", maxWidth: 360, bgcolor: "background.paper", marginLeft: "40%", marginTop: "20px"}}>
      {cartItems}
          <ListItem>
              <ListItemAvatar />
              <ListItemText>
